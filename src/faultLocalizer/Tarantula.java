...
public class Tarantula {
    ...
    public Tarantula( ArrayList<Integer> EFArray,ArrayList<Integer> EPArray,ArrayList<Integer> NFArray,ArrayList<Integer> NPArray){
    ...
    public ArrayList<Double> getSuspicion(){
        ...
        for(int i=0;i<EFArray.size();i++){
            ...
            Sus=((ef)/(ef+nf))/((ef/(ef+nf))+(ep/(ep+np)));
            if(Double.isNaN(Sus)){
                Sus=0;
            }
